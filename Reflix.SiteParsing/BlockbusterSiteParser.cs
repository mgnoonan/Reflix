...
{
    public class BlockbusterSiteParser : BaseSiteParser, ICustomSiteParser
    {
        public BlockbusterSiteParser(string url, DateTime startDate, string name, ILog log) : base(url, startDate, name, log) { }
